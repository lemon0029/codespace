...
public class ProductEventListener {
    ...
    @TransactionalEventListener(ProductSellOutStateChangedEvent.class)
    public void onProductSellOutStateChanged(ProductSellOutStateChangedEvent event) {
        log.info("Received product sell-out state changed event: {}", event);
        ...
        notifier.notify(new Notification() {
            ...
            public String messageContent() {
                ...
                StringBuilder builder = new StringBuilder();
                builder.append("Product sell-out state changed\n")
                        .append("> Code: ").append(product.getSaleCode()).append("\n");
